...
class AnalysisUrlThread(QThread):
    ...
    def get_response(self, html_url):
        ...
        with requests.Session() as s:
            response = s.get(url=html_url, headers=headers, timeout=10)
        return response
